...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (442310,319835,443587,316139,439696,439694,314378,319034,444101,439846,443580)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (442310,319835,443587,316139,439696,439694,314378,319034,444101,439846,443580)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44784623,4108670,4215140,312327,434376,438170,4270024,438172,4124687,4108215,4108678,4329847,319038,4108679,4108219,4108217,4108677,4108218,4108680)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44784623,4108670,4215140,312327,434376,438170,4270024,438172,4124687,4108215,4108678,4329847,319038,4108679,4108219,4108217,4108677,4108218,4108680)
  and c.invalid_reason is null
...
WHERE YEAR(C.drug_era_start_date) - P.year_of_birth >= 20
AND C.ordinal = 1
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-14,P.START_DATE) AND A.START_DATE <= DATEADD(day,14,P.START_DATE)
